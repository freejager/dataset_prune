...
import numpy as np
from random_data import load_data
...
def main():
    ...
    scheduler = torch.optim.lr_scheduler.OneCycleLR(optimizer, args.max_lr, steps_per_epoch=int((args.num_samples) * args.rate /args.batch_size),
