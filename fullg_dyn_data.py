...
def load_cifar10(args):
    ...
    train_loader_1 = torch.utils.data.DataLoader(dataset1, args.batch_size, shuffle=True,
                                               num_workers=args.workers, pin_memory=True)
    train_loader_2 = torch.utils.data.DataLoader(dataset2, args.batch_size, shuffle=True,
                                               num_workers=args.workers, pin_memory=True)
    train_loader_3 = torch.utils.data.DataLoader(dataset3, args.batch_size, shuffle=True,
                                               num_workers=args.workers, pin_memory=True)
    train_loader_4 = torch.utils.data.DataLoader(dataset4, args.batch_size, shuffle=True,
                                               num_workers=args.workers, pin_memory=True)
    train_loader_5 = torch.utils.data.DataLoader(dataset5, args.batch_size, shuffle=True,
                                               num_workers=args.workers, pin_memory=True)
