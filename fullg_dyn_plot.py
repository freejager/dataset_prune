...
def main():
    ...
    trainloader_new, keep_indices=train_double(args, all_sample_losses_1, all_sample_losses_2, all_sample_losses_3, all_sample_losses_4, all_sample_losses_5, train_data)
    ...
    plt.savefig(f'tsne_cifar10_fullg_dyn_{args.lbd}_{args.rate}.png')
    plt.show()
    print("fig save over")
