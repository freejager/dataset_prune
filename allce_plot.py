...
def main():
    ...
    trainloader_new, keep_indices=train_double(args, net1, train_loader, train_data)
    ...
    plt.savefig(f'tsne_cifar10_allce_{args.rate}.png')
    plt.show()
    print("fig save over")
...
def train_double(args, model, train_loader, train_data):
    all_sample_losses_1 = [] 

    all_sample_losses_1 = get_loss(train_loader, args, model)

    all_sample_losses = all_sample_losses_1
