...
def main():
    ...
    net1 = torch.nn.DataParallel(net1, device_ids=list(range(args.ngpu)))
    ...
    net4 = torch.nn.DataParallel(net4, device_ids=list(range(args.ngpu)))
    net5 = torch.nn.DataParallel(net5, device_ids=list(range(args.ngpu)))
    net_new = torch.nn.DataParallel(net_new, device_ids=list(range(args.ngpu)))
    ...
    trainloader_new=train_double(args, net, net1, net2, net3, net4, net5, trainloader1,trainloader2, trainloader3, trainloader4, trainloader5, train_data)
