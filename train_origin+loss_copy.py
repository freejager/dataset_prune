...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        # train for one epoch
        train_acc0, train_los0, loss_epoch0, output_epoch0, index_epoch0 = train(train_loader, args, net, criterion, optimizer, scheduler, epoch, log)
        ...
        is_best = recorder.update(epoch, train_los0, train_acc0, val_los, val_acc)
